...
const NAV_GROUPS = [
  ...
  {
    label: 'Insights',
    items: [{ label: 'Analytics', path: '/analytics', icon: 'analytics', flag: 'page_analytics' }],
  },
  {
    label: 'Configure',
    items: [
  ...
  return (
    <Link
      ...
      style={{
        ...
        borderRadius: 5,
        margin: '1px 8px',
        background: isActive ? 'var(--surface)' : hovered ? 'rgba(0,0,0,0.03)' : 'transparent',
