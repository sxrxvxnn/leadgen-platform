...
function OptionKey() {
  return (
    <svg fill="none" version="1.1" xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 32 32" style={{ width: 6, height: 6 }}>
  ...
  return (
    <div style={{
      ...
      ...(backlit ? {
        ...
        boxShadow: '0 20px 25px -5px rgba(255,255,255,0.4), 0 8px 10px -6px rgba(255,255,255,0.4)',
      } : {}),
    }}>
      <div style={{ ...faceBase, ...style }}>
        <div style={{ ...contentBase, ...childStyle }}>
          {children}
        </div>
      </div>
    </div>
...
function Keypad() {
  ...
  const MOD_L = { width: 40, alignItems: 'flex-end', justifyContent: 'flex-start', paddingBottom: 2, paddingLeft: 4 }
  const MOD_R = { width: 40, alignItems: 'flex-end', justifyContent: 'flex-end', paddingBottom: 2, paddingRight: 4 }
  ...
  return (
    <div style={{
      ...
      {/* ── Row 1 — Fn ──────────────────────────────────────────────── */}
      <div style={ROW}>
        <KBtn style={MOD_L} childStyle={CHILD_L}>esc</KBtn>
        {[
          [IconBrightnessDown, 'F1'], [IconBrightnessUp, 'F2'], [IconTable, 'F3'],
          [IconSearch, 'F4'], [IconMicrophone, 'F5'], [IconMoon, 'F6'],
          [IconPlayerTrackPrev, 'F7'], [IconPlayerSkipForward, 'F8'],
          [IconPlayerTrackNext, 'F9'], [IconVolume3, 'F10'],
          [IconVolume2, 'F11'], [IconVolume, 'F12'],
        ].map(([Icon, label]) => (
      ...
      <div style={ROW}>
        ...
        <KBtn><span style={{ display: 'block' }}>+</span><span style={{ display: 'block' }}>=</span></KBtn>
        <KBtn style={MOD_R} childStyle={CHILD_R}>delete</KBtn>
      </div>

      {/* ── Row 3 — QWERTY ──────────────────────────────────────────── */}
      <div style={ROW}>
        <KBtn style={MOD_L} childStyle={CHILD_L}>tab</KBtn>
        {['Q','W','E','R','T','Y','U','I','O','P'].map(k => (
          <KBtn key={k}><span style={{ display: 'block' }}>{k}</span></KBtn>
        ))}
        <KBtn><span style={{ display: 'block' }}>{'{'}</span><span style={{ display: 'block' }}>{'['}</span></KBtn>
        <KBtn><span style={{ display: 'block' }}>{'}'}</span><span style={{ display: 'block' }}>{']'}</span></KBtn>
        <KBtn><span style={{ display: 'block' }}>|</span><span style={{ display: 'block' }}>\</span></KBtn>
      ...
      {/* ── Row 4 — ASDF ────────────────────────────────────────────── */}
      <div style={ROW}>
        <KBtn style={{ width: '2.8rem', alignItems: 'flex-end', justifyContent: 'flex-start', paddingBottom: 2, paddingLeft: 4 }} childStyle={CHILD_L}>
          caps lock
        </KBtn>
        ...
        <KBtn><span style={{ display: 'block' }}>:</span><span style={{ display: 'block' }}>;</span></KBtn>
        <KBtn><span style={{ display: 'block' }}>"</span><span style={{ display: 'block' }}>'</span></KBtn>
        <KBtn style={{ width: '2.85rem', alignItems: 'flex-end', justifyContent: 'flex-end', paddingBottom: 2, paddingRight: 4 }} childStyle={CHILD_R}>
          return
        </KBtn>
      </div>
      ...
      {/* ── Row 5 — ZXCV ────────────────────────────────────────────── */}
      <div style={ROW}>
        <KBtn style={{ width: '3.65rem', alignItems: 'flex-end', justifyContent: 'flex-start', paddingBottom: 2, paddingLeft: 4 }} childStyle={CHILD_L}>
          shift
        </KBtn>
        {['Z','X','C','V','B','N','M'].map(k => (
          <KBtn key={k}><span style={{ display: 'block' }}>{k}</span></KBtn>
        ...
        <KBtn><span style={{ display: 'block' }}>{'>'}</span><span style={{ display: 'block' }}>{'.'}</span></KBtn>
        <KBtn><span style={{ display: 'block' }}>{'?'}</span><span style={{ display: 'block' }}>{'/'}</span></KBtn>
        <KBtn style={{ width: '3.65rem', alignItems: 'flex-end', justifyContent: 'flex-end', paddingBottom: 2, paddingRight: 4 }} childStyle={CHILD_R}>
          shift
        </KBtn>
      </div>
      ...
      <div style={{ ...ROW, marginBottom: 0 }}>
        <KBtn style={MOD_L} childStyle={CHILD_L}>
          <div style={{ display: 'flex', width: '100%', justifyContent: 'flex-end', paddingRight: 4 }}><span>fn</span></div>
          <div style={{ display: 'flex', width: '100%', justifyContent: 'flex-start', paddingLeft: 4 }}><IconWorld style={ICO} /></div>
        </KBtn>
        <KBtn style={MOD_L} childStyle={CHILD_L}>
          <div style={{ display: 'flex', width: '100%', justifyContent: 'flex-end', paddingRight: 4 }}><IconChevronUp style={ICO} /></div>
          <div style={{ display: 'flex', width: '100%', justifyContent: 'flex-start', paddingLeft: 4 }}><span>control</span></div>
        </KBtn>
        <KBtn style={MOD_L} childStyle={CHILD_L}>
          <div style={{ display: 'flex', width: '100%', justifyContent: 'flex-end', paddingRight: 4 }}><OptionKey /></div>
          <div style={{ display: 'flex', width: '100%', justifyContent: 'flex-start', paddingLeft: 4 }}><span>option</span></div>
        </KBtn>
        <KBtn style={{ width: 32, alignItems: 'flex-end', justifyContent: 'flex-start', paddingBottom: 2, paddingLeft: 4 }} childStyle={CHILD_L}>
          <div style={{ display: 'flex', width: '100%', justifyContent: 'flex-end', paddingRight: 4 }}><IconCommand style={ICO} /></div>
          <div style={{ display: 'flex', width: '100%', justifyContent: 'flex-start', paddingLeft: 4 }}><span>command</span></div>
        </KBtn>
        {/* Space bar */}
        <KBtn style={{ width: '8.2rem' }} />
        <KBtn style={{ width: 32, alignItems: 'flex-end', justifyContent: 'flex-start', paddingBottom: 2, paddingLeft: 4 }} childStyle={CHILD_L}>
          <div style={{ display: 'flex', width: '100%', justifyContent: 'flex-start', paddingLeft: 4 }}><IconCommand style={ICO} /></div>
          <div style={{ display: 'flex', width: '100%', justifyContent: 'flex-start', paddingLeft: 4 }}><span>command</span></div>
        </KBtn>
        <KBtn style={{ width: 40, alignItems: 'flex-end', justifyContent: 'flex-start', paddingBottom: 2, paddingLeft: 4 }} childStyle={CHILD_L}>
          <div style={{ display: 'flex', width: '100%', justifyContent: 'flex-start', paddingLeft: 4 }}><OptionKey /></div>
          <div style={{ display: 'flex', width: '100%', justifyContent: 'flex-start', paddingLeft: 4 }}><span>option</span></div>
        </KBtn>
        {/* Arrow cluster */}
        <div style={{ marginTop: 2, display: 'flex', height: 24, width: '4.9rem', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-end', borderRadius: 4, padding: 0.5 }}>
          <KBtn style={{ height: 12, width: 24 }} childStyle={{ height: '100%', justifyContent: 'center' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <svg width="30" height="30" viewBox="0 0 16 16" fill="none" style={{ opacity: 0.55 }}>
            ...
            <line x1="9.1" y1="6.9" x2="13" y2="3" stroke="white" strokeWidth="0.7" strokeLinecap="round" />
          </svg>
        </div>
      </div>
