...
const s = {
  ...
  toolbar: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '14px 24px', borderBottom: '1px solid rgba(253,253,253,0.08)', background: 'var(--text)', flexShrink: 0, gap: '10px', flexWrap: 'wrap' },
  ...
  btn: { padding: '7px 14px', background: 'var(--accent)', border: 'none', borderRadius: '7px', fontFamily: 'var(--font-mono)', fontSize: '10px', fontWeight: '600', letterSpacing: '0.04em', color: '#FFFFFF', cursor: 'pointer', whiteSpace: 'nowrap' },
