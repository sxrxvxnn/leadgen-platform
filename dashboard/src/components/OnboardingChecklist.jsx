...
const STEPS = [
  ...
  },
  {
    ...
    desc: 'Build an automated outreach campaign.',
    path: '/sequences',
    action: 'New Sequence',
  },
  {
    ...
    desc: 'Enroll a lead and fire the first step.',
    path: '/sequences',
            ...
            >
              <div
                style={{
                  height: '100%',
                  width: `${pct}%`,
                  background: allDone ? '#059669' : '#E7000B',
                  borderRadius: 2,
