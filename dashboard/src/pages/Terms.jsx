      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              'radial-gradient(ellipse 55% 90% at 5% 50%, var(--accent-dimmer) 0%, transparent 70%)',
            pointerEvents: 'none',
          }}
        />
      ...
      >
        ...
        <main style={{ flex: 1, paddingTop: '48px', maxWidth: '680px' }}>
          <Section id="acceptance" title="Acceptance of Terms">
            <p>
              By accessing or using Sonar ("the Service", "the Platform") at{' '}
              <strong>sonarleads.vercel.app</strong>, you agree to be bound by these Terms of
            ...
            <p>
              ...
              Shravan Omanakuttan ("we", "us", "our"), the operator of Sonar.
            </p>
          </Section>

          <Section id="description" title="The Service">
            <p>
              Sonar is a B2B sales intelligence and lead management platform that enables users to:
            </p>
            <ul style={s.list}>
              <li>Discover, import, and manage B2B company and contact records</li>
              <li>
                Enrich lead data via third-party integrations (LinkedIn, Google Maps, Hunter.io,
                Apollo.io)
              </li>
          ...
          <Section id="accounts" title="Accounts & Registration">
            ...
            <p>
              ...
              Terms. Accounts registered on behalf of an organisation represent that you have
          ...
          <Section id="acceptable" title="Acceptable Use">
            <p>
              You agree to use the Service only for lawful B2B sales and marketing purposes. You
              must not:
            </p>
            <ul style={s.list}>
              <li>
                Use the Service to scrape, harvest, or collect data in violation of any third
                party's terms of service
              </li>
              <li>
                Use lead data to send unsolicited bulk communications (spam) in violation of
                applicable law
              </li>
              <li>
              ...
              <li>
                Use the Service to store or process sensitive personal data including health,
              ...
              <li>
                Use the Service to engage in any activity that violates LinkedIn's terms of service
                or API usage policies
              </li>
              <li>
          ...
          <Section id="data" title="Your Data">
            <p>
              You retain ownership of all company, contact, and lead data you upload or create
              within Sonar ("User Data"). By using the Service, you grant us a limited licence to
              store, process, and display your User Data solely for the purpose of providing the
              Service.
            </p>
            <p>
              You are responsible for ensuring you have the right to upload and process any data you
              add to the platform, including compliance with applicable data protection laws
              (including India's DPDP Act 2023 and GDPR where applicable).
            </p>
            <p>
              We will not sell, share, or use your User Data for purposes beyond operating and
              improving the Service. On account termination, your data will be deleted within 30
              days upon request.
            </p>
          </Section>
          ...
          <Section id="linkedin" title="LinkedIn API Data">
            <p>
              Sonar integrates with LinkedIn's APIs subject to the{' '}
              <a
              ...
              . By connecting LinkedIn to your account, you agree that:
            </p>
            <ul style={s.list}>
              <li>
                You authorise Sonar to access LinkedIn data on your behalf within the scope you
                approve
              </li>
              <li>
                LinkedIn data retrieved through our integration may only be used for your own sales
                and marketing activities
              </li>
              <li>
                You will not use LinkedIn data obtained through the Service to build competing
                products or data sets
              </li>
              <li>
                LinkedIn data is subject to LinkedIn's own terms and privacy policies in addition to
                ours
              </li>
              <li>
                You can disconnect LinkedIn access at any time via your LinkedIn account settings
              </li>
            </ul>
          </Section>
          ...
          <Section id="ip" title="Intellectual Property">
            <p>
              The Sonar platform, including its design, code, branding, and content (excluding User
              Data), is owned by Shravan Omanakuttan and protected by applicable intellectual
              property laws.
            </p>
            <p>
              You are granted a limited, non-exclusive, non-transferable licence to use the Service
              for its intended purpose during your subscription or access period. This licence does
              not include the right to copy, modify, or create derivative works of the Service.
            </p>
            <p>
          ...
          <Section id="disclaimers" title="Disclaimers">
            ...
            <ul style={s.list}>
              ...
              <li>
                LinkedIn profile or company data obtained through the Service will be current or
                correct
              </li>
          ...
          <Section id="liability" title="Limitation of Liability">
            <p>
              To the maximum extent permitted by applicable law, Shravan Omanakuttan and Sonar shall
              not be liable for any indirect, incidental, special, consequential, or punitive
              damages, including loss of profits, data, or business opportunities, arising from your
              use of the Service.
            </p>
            <p>
              ...
              claim, or ₹5,000 (Indian Rupees five thousand), whichever is greater.
            </p>
          </Section>

          <Section id="termination" title="Termination">
            <p>
              Either party may terminate these Terms at any time. You may close your account by
              contacting us. We may suspend or terminate your access immediately if you breach these
              Terms or if we are required to do so by law.
            </p>
            <p>
              On termination, your right to use the Service ceases immediately. Sections covering
          ...
          <Section id="changes" title="Changes to These Terms">
            <p>
              ...
              the platform or by email at least 14 days before taking effect. Continued use of the
          ...
          <Section id="contact" title="Contact" last>
            ...
            >
              ...
              <a
                ...
                style={{ ...s.link, fontSize: '13px', marginTop: '4px' }}
              >
