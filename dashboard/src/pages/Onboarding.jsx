...
export default function Onboarding() {
  ...
  return (
    <motion.div
      style={{ background: BG, minHeight: '100vh', fontFamily: SANS, color: INK }}
              ...
              {i < STEPS.length - 1 && (
                <div
                  style={{
                    width: 28,
                    height: 1.5,
                    background: step > s.num ? ACC : LINE,
                    margin: '0 8px',
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 24, maxWidth: 480 }}>
              ...
              <div>
                <AnimatedButton
                  ...
                  style={{
                    opacity: !mode || loading || (mode === 'team' && !teamName.trim()) ? 0.5 : 1,
        ...
        >
          ...
          >
            <div style={{ padding: '48px 40px 64px', borderRight: `1px solid ${LINE}` }}>
              ...
              <div
                style={{
                  background: 'rgba(111,99,183,0.06)',
                  border: '1px solid rgba(111,99,183,0.2)',
                  borderRadius: 8,
                  padding: '12px 16px',
                  marginBottom: 28,
                  fontSize: 13,
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
                ...
                {smtpError && (
                  <p style={{ fontSize: 13, color: '#b83232', margin: 0 }}>{smtpError}</p>
                )}
                ...
                <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
                  ...
                  {smtpSaved && (
                    <span style={{ fontFamily: SANS, fontSize: 13, color: '#4a7c59' }}>
                      SMTP configured!
                    </span>
                  )}
                </div>
        ...
        >
          ...
          >
            <div style={{ padding: '56px 40px 64px', borderRight: `1px solid ${LINE}` }}>
              ...
              >
                Search 800M+ professionals with Sonar Prospect — filter by title, company size,
                location, and more.
              </p>
              <AnimatedButton
                variant="shimmer"
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  ...
                  >
                    <div
                      style={{
                        ...
                        height: 36,
                        borderRadius: 8,
                        background: 'rgba(111,99,183,0.1)',
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                        fontSize: 18,
                    ...
                    <div>
                      ...
                      <div style={{ fontFamily: SANS, fontSize: 12, color: MID }}>
                        Upload an existing leads list
                      </div>
                    </div>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        Use Chrome extension on LinkedIn
                      </div>
                      <div style={{ fontFamily: SANS, fontSize: 12, color: MID }}>
                        Extract leads from any LinkedIn page
                      </div>
                    </div>
                  </a>
                </div>
            ...
            >
              {[
                ...
                },
                {
                  ...
                  note: smtpSaved
                    ? smtpUser
                    : 'Sequences may not send — configure in Settings → Email',
                },
              ].map((item, i) => (
                <div
                  key={item.label}
                  ...
                  <div>
                    <div
                      style={{
                        ...
                        fontSize: 14,
                        fontWeight: 600,
                        color: item.done ? INK : MID,
                      }}
                    >
                      {item.label}
                    </div>
                    {item.note && (
                      <div style={{ fontFamily: SANS, fontSize: 12, color: MID, marginTop: 2 }}>
                        {item.note}
                      </div>
                    )}
                  </div>
