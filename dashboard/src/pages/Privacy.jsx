      ...
      >
        ...
        <main style={{ flex: 1, paddingTop: '48px', maxWidth: '680px' }}>
          <Section id="introduction" title="Introduction">
            <p>
              Sonar is a B2B sales intelligence and lead management platform operated by Shravan
              Omanakuttan. This Privacy Policy explains how we collect, use, store, and protect
              information when you use our platform at <strong>sonarleads.vercel.app</strong>.
            </p>
            <p>
              By using Sonar, you agree to the collection and use of information in accordance with
              this policy. We are committed to compliance with the{' '}
              <strong>Digital Personal Data Protection Act, 2023 (DPDP Act)</strong> and applicable
              international privacy standards including the LinkedIn API Terms of Service.
            </p>
          </Section>
          ...
          <Section id="data-collected" title="Data Collected">
            ...
            <p>
              When you register, we collect your name, email address, and a hashed password used
              solely for authentication and account management.
            </p>

            <SubHeading>Company and Lead Data</SubHeading>
            <p>
              Our platform stores B2B company and contact information you add, import, or that is
              enriched through third-party integrations. This is business-professional data (company
              names, job titles, business email addresses, LinkedIn URLs) and does not include
              sensitive personal categories.
            </p>

            <SubHeading>LinkedIn Data</SubHeading>
            <p>
              Where you authorise LinkedIn API access, we may retrieve publicly available LinkedIn
              company profile data (follower counts, descriptions, industry, headquarters, employee
              range) and Lead Gen Form submissions from your own LinkedIn ad campaigns.
            </p>

            <SubHeading>Usage Analytics</SubHeading>
            <p>
              We collect anonymised product analytics (page views, feature interactions, error
              events) via PostHog to improve the platform. No personally identifiable information is
              shared beyond a pseudonymous user identifier.
            </p>

            <SubHeading>API Keys</SubHeading>
            <p>
              API keys you enter in Settings are stored locally in your browser's localStorage and
          ...
          <Section id="storage" title="Storage & Security">
            <p>
              All user and company data is stored in <strong>Supabase</strong> (PostgreSQL), hosted
              on EU-West servers. We enforce Row Level Security (RLS) policies ensuring each user
              can only access their own data. All communications are encrypted in transit over
              HTTPS.
            </p>
            <p>
              We retain your data for as long as your account is active. You may request deletion at
          ...
          <Section id="third-parties" title="Third-Party Services">
            <p style={{ marginBottom: '16px' }}>
              Sonar integrates with the following services, each governed by their own privacy
              policies:
            </p>
            <div style={s.table}>
          ...
          <Section id="linkedin" title="LinkedIn API Data Policy">
            <p>
              Sonar's use of LinkedIn API data complies with the{' '}
              <a
            ...
            <ul style={s.list}>
              <li>
                LinkedIn lead data is only accessed with the explicit authorisation of the account
                owner
              </li>
              <li>
                Lead data is used solely to populate the authorising user's pipeline within Sonar
              </li>
              <li>
                LinkedIn data is not sold, redistributed, or used beyond the authorised integration
              </li>
              <li>
                Users can revoke LinkedIn API access at any time via their LinkedIn account settings
              </li>
              <li>
                We do not store LinkedIn member passwords or access tokens beyond the active session
              </li>
            </ul>
          </Section>
