...
const TESTIMONIALS = [
  {
    quote:
      'Sonar cut our prospecting time by 70%. We went from 2 hours of manual research per lead to instant enriched records ready to reach out.',
    name: 'Arjun Mehta',
    role: 'Head of Sales, NovaSpark AI',
  },
  {
    quote:
      'The ICP scoring is what makes it different. Every morning I open Sonar and my best-fit leads are already ranked and ready.',
    name: 'Priya Nair',
    role: 'Founder, CloudOps Ltd',
  },
  {
    quote:
      'We used to miss SaaS companies in the 20–50 headcount range. Sonar finds them all and enriches them automatically.',
    name: 'Liam Chen',
    role: 'SDR Lead, Stackify',
  },
  {
    quote:
      'Installing the Chrome extension took 2 minutes. I pulled 80 qualified leads from LinkedIn in my first session.',
    name: 'Sarah Kim',
    role: 'AE, ScaleAI Corp',
  },
  {
    quote:
      'Finally a tool that combines discovery, enrichment, and scoring in one place. No more juggling 4 different tools.',
    name: 'Marcus Weber',
    role: 'RevOps, InnovateTech',
  },
  {
    quote:
      'The Hunter integration is seamless — every company record comes with verified emails. Our cold email reply rate is up 3x.',
    name: 'Deepika Rao',
    role: 'GTM Lead, Finverse',
  },
]
...
const FEATURE_TABS = [
  {
    ...
    visual: (
      <div className="lp-tab-visual">
        <div className="lp-tv-header">
          <span className="lp-tv-dot y"></span>
          <span className="lp-tv-label">Company Directory</span>
        </div>
        {[
          ...
          >
            ...
            <div className="lp-tv-row-score" style={{ '--s': c.score + '%' }}>
              {c.score}
            </div>
          </motion.div>
        ))}
  ...
  },
  {
    ...
    visual: (
      <div className="lp-tab-visual">
        <div className="lp-tv-header">
          <span className="lp-tv-dot g"></span>
          <span className="lp-tv-label">Enrichment queue — live</span>
        </div>
        {[
  ...
  },
  {
    ...
    visual: (
      <div className="lp-tab-visual">
        <div className="lp-tv-header">
          <span className="lp-tv-dot y"></span>
          <span className="lp-tv-label">ICP Score breakdown</span>
        </div>
        {[
          ...
          >
            ...
            <div className="lp-tv-bar-track">
              <motion.div
                className="lp-tv-bar-fill"
                initial={{ width: 0 }}
  ...
  },
  {
    ...
    visual: (
      <div className="lp-tab-visual">
        <div className="lp-tv-header">
          <span className="lp-tv-dot g"></span>
          <span className="lp-tv-label">Export · 24 leads selected</span>
        </div>
        {[
          ...
          <motion.div
            key={o.label}
            className={`lp-tv-row${o.active ? ' active' : ''}`}
            initial={{ opacity: 0, x: 12 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            transition={{ delay: i * 0.08 }}
      ...
      <section className="lp-hero" style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="lp-container lp-hero-center" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <motion.p className="lp-hero-sub lp-hero-sub-center" {...fadeUp(0.16)}>
            Sonar discovers B2B companies, enriches every data point with AI, and scores them
            against your ICP. From first search to outreach-ready lead — in one platform.
          </motion.p>
      ...
      >
        ...
        <div className="lp-preview-body">
          <div className="lp-preview-row">
            ...
            <div className="lp-preview-bar-score">
      ...
      <section className="lp-section lp-section-alt">
        <div className="lp-container">
          <motion.div className="lp-section-header" {...fadeUp()}>
            ...
            <h2>
              Manually building your
              <br />
              prospect list is exhausting.
            </h2>
          </motion.div>
      ...
      <section className="lp-section lp-section-dark" id="features">
        <div className="lp-container">
          <motion.div className="lp-section-header" {...fadeUp()}>
            ...
            <p className="lp-section-sub" style={{ color: '#6A7282' }}>
              Purpose-built for B2B outreach — from discovery to deal-ready lead, everything
              automated.
            </p>
          </motion.div>
          ...
          >
            <motion.div style={{ gridColumn: '1 / 3' }} {...fadeUp(0)}>
              <BentoCard bg="linear-gradient(135deg, #E7000B 0%, #b30009 100%)" minHeight={300}>
                <div style={{ maxWidth: 340 }}>
                  ...
                  >
                    Search 10M+ B2B companies by industry, size, and location. Every company gets an
                    automatic ICP fit score — your best accounts always surface first.
                  </p>
                </div>
              </BentoCard>
            </motion.div>
            ...
            <motion.div style={{ gridColumn: '3 / 4' }} {...fadeUp(0.08)}>
              <BentoCard bg="linear-gradient(135deg, #9D0010 0%, #5c0008 100%)" minHeight={300}>
                ...
                >
                  All data encrypted over HTTPS. Your LinkedIn cookie stays on your own backend. Row
                  Level Security ensures only you see your records.
                </p>
              </BentoCard>
            </motion.div>
          </div>
          ...
          <motion.div {...fadeUp(0.16)}>
            <BentoCard bg="linear-gradient(135deg, #1a0404 0%, #0d0202 100%)" minHeight={300}>
              <div style={{ maxWidth: 480 }}>
                ...
                >
                  Chrome extension pulls leads from any LinkedIn page. Hunter.io verifies emails,
                  Apollo supplements data — everything flows automatically into your workspace with
                  zero copy-paste.
                </p>
              </div>
            </BentoCard>
          ...
          >
            <motion.div style={{ gridColumn: '1 / 2' }} {...fadeUp(0)}>
              <BentoCard bg="linear-gradient(135deg, #9D0010 0%, #5c0008 100%)" minHeight={340}>
                ...
                >
                  Define your ideal customer — industry, company size, location, and role keywords.
                  Sonar uses this profile to score every company it discovers.
                </p>
              </BentoCard>
            </motion.div>
            ...
            <motion.div style={{ gridColumn: '2 / 4' }} {...fadeUp(0.08)}>
              <BentoCard bg="linear-gradient(135deg, #E7000B 0%, #b30009 100%)" minHeight={340}>
                ...
                <div style={{ maxWidth: 420 }}>
                  ...
                  >
                    Search the company directory or use the Maps explorer. Add targets to your
                    workspace, then let AI fill website data, LinkedIn profiles, and verified emails
                    automatically.
                  </p>
                </div>
              </BentoCard>
          ...
          <motion.div {...fadeUp(0.16)}>
            <BentoCard bg="linear-gradient(135deg, #1a0404 0%, #0d0202 100%)" minHeight={240}>
              <div style={{ maxWidth: 540 }}>
                ...
                >
                  Your leads arrive with verified emails, LinkedIn profiles, job titles, and ICP
                  scores. Export a clean list or open LinkedIn profiles in batch — ready to reach
                  out immediately.
                </p>
              </div>
            </BentoCard>
        ...
        <div className="lp-container">
          <motion.div className="lp-testimonial-hl" {...fadeUp()}>
            <svg className="lp-quote-mark" viewBox="0 0 40 32" fill="none">
              <path
                d="M0 20C0 13 4 8 12 5L14 8C10 10 8 13 8 16H14V32H0V20ZM22 20C22 13 26 8 34 5L36 8C32 10 30 13 30 16H36V32H22V20Z"
                fill="currentColor"
                opacity="0.18"
              />
            </svg>
            <blockquote className="lp-hl-quote">
              Sonar cut our prospecting time by{' '}
              <span style={{ color: 'var(--lp-accent)' }}>70%</span>. We went from 2 hours of manual
              research per lead to instant enriched records ready to reach out.
            </blockquote>
        ...
        <div className="lp-container">
          <motion.div className="lp-globe-section" {...fadeUp()}>
            <div className="lp-globe-copy">
              ...
              <p className="lp-globe-sub" style={{ color: '#6A7282' }}>
                Sonar indexes B2B companies from across the globe, with deep enrichment for
                companies in India, APAC, Europe, and North America.
              </p>
        ...
        <div className="lp-container">
          <div className="lp-ext-grid">
            <motion.div className="lp-ext-copy" {...fadeUp()}>
              <span className="lp-pill" style={{ marginBottom: '20px', display: 'inline-flex' }}>
                Chrome extension
              </span>
              <h2 style={{ marginTop: '20px', color: 'var(--lp-text)' }}>
                Extract leads straight
                <br />
                from LinkedIn.
              </h2>
              <p className="lp-ext-sub">
                Install the Sonar extension and pull people and companies from any LinkedIn page —
                profiles, company pages, search results, Sales Navigator — directly into your
                workspace. No copy-paste, no CSV.
              </p>
              <ul className="lp-ext-features">
                <li>
                  <span className="lp-ext-dash">—</span>Extract from LinkedIn people search &amp;
                  Sales Nav
                </li>
                <li>
                  <span className="lp-ext-dash">—</span>Scrape full profiles: bio, experience, job
                  title
                </li>
                <li>
                  <span className="lp-ext-dash">—</span>Auto-scroll to load all results before
                  extracting
                </li>
                <li>
                  <span className="lp-ext-dash">—</span>Works on company pages, people pages &amp;
                  search
                </li>
                <li>
                  <span className="lp-ext-dash">—</span>One click — leads appear in your dashboard
                  instantly
                </li>
              </ul>
              <div className="lp-ext-actions">
                ...
                <ol className="lp-ext-steps">
                  <li>
                    <span className="lp-ext-step-num">1</span>Download and <strong>unzip</strong>{' '}
                    the file
                  </li>
                  <li>
                    <span className="lp-ext-step-num">2</span>Open <code>chrome://extensions</code>{' '}
                    in Chrome
                  </li>
                  <li>
                    <span className="lp-ext-step-num">3</span>Toggle on{' '}
                    <strong>Developer mode</strong> (top right)
                  </li>
                  <li>
                    <span className="lp-ext-step-num">4</span>Click <strong>Load unpacked</strong> →
                    select folder
                  </li>
                  <li>
                    <span className="lp-ext-step-num">5</span>Pin Sonar to your toolbar and sign in
                  </li>
                </ol>
              </div>
            </motion.div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 16 }}>
              ...
              <BentoCard bg="linear-gradient(135deg, #C90008 0%, #8a0006 100%)" minHeight={260}>
                <div style={{ display: 'flex', gap: 20, alignItems: 'flex-start' }}>
                  ...
                  <div>
                    ...
                    <div
                      style={{ color: 'rgba(255,255,255,0.72)', fontSize: 15, lineHeight: 1.65 }}
                    >
                      AI reads company websites to extract descriptions, industry signals, and tech
                      stack clues — no manual research.
                    </div>
                  </div>
                </div>
              </BentoCard>
            ...
            <motion.div style={{ gridColumn: '3 / 4' }} {...fadeUp(0.07)}>
              <BentoCard bg="linear-gradient(135deg, #1a0505 0%, #0a0000 100%)" minHeight={260}>
                ...
                <div style={{ color: 'rgba(255,255,255,0.72)', fontSize: 14, lineHeight: 1.65 }}>
                  Pull company LinkedIn pages, decision-maker profiles, headcount, and job titles
            ...
            <motion.div style={{ gridColumn: '1 / 2' }} {...fadeUp(0.12)}>
              <BentoCard bg="linear-gradient(135deg, #0d0202 0%, #180303 100%)" minHeight={260}>
                ...
                <div style={{ color: 'rgba(255,255,255,0.72)', fontSize: 14, lineHeight: 1.65 }}>
                  Hunter.io integration finds and verifies professional email addresses for every
                  contact you want to reach.
                </div>
              </BentoCard>
            </motion.div>
                ...
                <div style={{ display: 'flex', gap: 20, alignItems: 'flex-start' }}>
                  ...
                  <div>
                    ...
                    <div
                      style={{ color: 'rgba(255,255,255,0.72)', fontSize: 15, lineHeight: 1.65 }}
                    >
                      Discover local and regional businesses via Google Maps and enrich their
                      details — ideal for territory-based sales.
                    </div>
                  </div>
                </div>
              </BentoCard>
            ...
            {/* Row 3: 2/3 + 1/3 */}
            <motion.div style={{ gridColumn: '1 / 3' }} {...fadeUp(0.2)}>
                ...
                <div style={{ display: 'flex', gap: 20, alignItems: 'flex-start' }}>
                  ...
                  <div>
                    ...
                    <div
                      style={{ color: 'rgba(255,255,255,0.72)', fontSize: 15, lineHeight: 1.65 }}
                    >
                      Every company gets an automatic fit score against your saved ICP criteria so
                      your best-fit accounts rise to the top.
                    </div>
                  </div>
                </div>
              </BentoCard>
            ...
            <motion.div style={{ gridColumn: '3 / 4' }} {...fadeUp(0.24)}>
              <BentoCard bg="linear-gradient(135deg, #160202 0%, #0a0101 100%)" minHeight={220}>
                ...
                <div style={{ color: 'rgba(255,255,255,0.72)', fontSize: 14, lineHeight: 1.65 }}>
                  AI classifies every company into the right sector — SaaS, Fintech, Healthtech,
                  Cybersecurity — on enrichment.
                </div>
              </BentoCard>
            </motion.div>
          </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                  ...
                  <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 28px', flex: 1 }}>
                    {[
                      ...
                      >
                        <span style={{ color: '#E7000B', flexShrink: 0, marginTop: 1 }}>—</span>
                        {f}
                      </li>
                    ))}
                  </ul>
            ...
            <motion.div style={{ gridColumn: '2 / 4' }} {...fadeUp(0.08)}>
              <BentoCard bg="linear-gradient(135deg, #E7000B 0%, #9D0000 100%)" minHeight={480}>
                <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                  ...
                  <div
                    style={{ height: 1, background: 'rgba(255,255,255,0.2)', marginBottom: 24 }}
                  />
                  <ul
                    style={{
                      listStyle: 'none',
                  ...
                  >
                    {[
                      ...
                      >
                        <span
                          style={{ color: 'rgba(255,255,255,0.5)', flexShrink: 0, marginTop: 1 }}
                        >
                          —
                        </span>
                        {f}
                  ...
                  <a
                    href="mailto:sonarleads@proton.me"
                    style={{
                      display: 'block',
                      background: 'white',
                      color: '#E7000B',
              ...
              >
                ...
                <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                  {[
                    ...
                    >
                      <span style={{ color: 'rgba(255,255,255,0.4)', flexShrink: 0, marginTop: 1 }}>
                        —
                      </span>
                      {f}
                    </li>
      ...
      <section className="lp-section lp-section-alt">
        <div className="lp-container">
          ...
          <div className="lp-faq">
            ...
            <p className="lp-faq-footer">
              Still have questions? Email us at{' '}
              <a href="mailto:sonarleads@proton.me">sonarleads@proton.me</a>
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="lp-footer-inner">
          ...
          <div className="lp-footer-cols">
            ...
            <div className="lp-footer-col">
              ...
              <button onClick={() => setLegal('privacy')} className="lp-footer-btn">
                Privacy Policy
              </button>
              <button onClick={() => setLegal('terms')} className="lp-footer-btn">
                Terms of Service
              </button>
            </div>
            <div className="lp-footer-col">
