          ...
          <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
            <button
              ...
              style={{
                ...
                padding: '7px 14px',
                background: !showDone ? 'var(--text)' : 'var(--surface)',
                color: !showDone ? 'var(--bg)' : 'var(--text-muted)',
            ...
            <div style={{ textAlign: 'center', padding: '72px 0' }}>
              ...
              >
                {showDone
                  ...
                  : 'Open a lead in the Leads page and add tasks from the drawer.'}
              </p>
              <button
...
function TaskCard({ task, onToggle, onDelete, navigate }) {
  ...
  return (
    ...
    >
      ...
      >
        {task.completed && (
          <span style={{ color: 'var(--bg)', fontSize: 10, fontWeight: 700, lineHeight: 1 }}>
            ✓
          </span>
        )}
      </button>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
        {due && (
          <span style={{ fontFamily: MONO, fontSize: 10, color: 'var(--text-muted)' }}>{due}</span>
        )}
        <span
          style={{
            fontFamily: MONO,
