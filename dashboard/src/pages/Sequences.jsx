...
const PREVIEW_LEAD = {
  ...
  company: 'Acme Corp',
  title: 'VP of Sales',
  cal_link: 'https://cal.com/you/15min',
}
      ...
      >
        <div style={{ display: 'flex', gap: 8, marginBottom: 12, flexWrap: 'wrap' }}>
          {STEP_TYPES.map((t) => (
            <button
              key={t.id}
              onClick={() => onChange({ ...step, type: t.id })}
              style={{
                padding: '5px 12px',
                borderRadius: 6,
                border: step.type === t.id ? '1.5px solid #E7000B' : '1px solid var(--border)',
                background: step.type === t.id ? '#E7000B18' : 'transparent',
                color: step.type === t.id ? '#E7000B' : 'var(--text-muted)',
                fontFamily: 'var(--font-mono)',
                fontSize: 11,
                fontWeight: 600,
                cursor: 'pointer',
          ...
          {step.type === 'email' && (
            <button
              ...
              style={{
                padding: '5px 10px',
                borderRadius: 6,
                border: abEnabled ? '1.5px solid #b07d2e' : '1px solid var(--border)',
                background: abEnabled ? '#b07d2e18' : 'transparent',
                color: abEnabled ? '#b07d2e' : 'var(--text-muted)',
                fontFamily: 'var(--font-mono)',
                fontSize: 11,
                fontWeight: 600,
                cursor: 'pointer',
          ...
          {step.type === 'email' && (
            <button
              ...
              style={{
                padding: '5px 10px',
                borderRadius: 6,
                border: showTplPicker ? '1.5px solid #059669' : '1px solid var(--border)',
                background: showTplPicker ? '#05966918' : 'transparent',
                color: showTplPicker ? '#059669' : 'var(--text-muted)',
                fontFamily: 'var(--font-mono)',
                fontSize: 11,
                fontWeight: 600,
                cursor: 'pointer',
          ...
          {step.type === 'email' && (
            <button
              ...
              style={{
                padding: '5px 10px',
                borderRadius: 6,
                border: previewMode ? '1.5px solid #5b8db8' : '1px solid var(--border)',
                background: previewMode ? '#5b8db818' : 'transparent',
                color: previewMode ? '#5b8db8' : 'var(--text-muted)',
                fontFamily: 'var(--font-mono)',
                fontSize: 11,
                fontWeight: 600,
                cursor: 'pointer',
        ...
        {showTplPicker && step.type === 'email' && (
          ...
          >
            ...
            {tplLoading ? (
              ...
              >
                No saved templates yet. Create them in Settings → Email Templates.
              </p>
            ) : (
              <div
                style={{
        ...
        {step.type === 'wait' ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <textarea
              rows={step.type === 'email' ? 5 : 3}
              placeholder={
                step.type === 'email'
                  ? 'Email body… Use {{name}}, {{company}}, {{title}}, {{cal_link}} for personalization.'
                  : step.type === 'linkedin'
                    ? 'LinkedIn message…'
                    : 'Call notes or script…'
              }
              value={step.body || ''}
            ...
            {step.type === 'email' && abEnabled && (
              <div style={{ marginTop: 8, paddingTop: 12, borderTop: '1px dashed var(--border)' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  <input
                    type="text"
                    placeholder="Subject line B… (leave blank to use Subject A)"
            ...
            <>
                ...
                <div>
                  ...
                  >
                    ...
                    <AnalyticsBadge
                      ...
                      sub={`${analytics.unique_opens} opens`}
                      color={analytics.open_rate > 20 ? '#4a7c59' : undefined}
                    />
                    <AnalyticsBadge
                      label="Click Rate"
                      value={`${analytics.click_rate}%`}
                      sub={`${analytics.unique_clicks} clicks`}
                      color={analytics.click_rate > 5 ? '#0082F3' : undefined}
                    />
                    <AnalyticsBadge
                      label="Replied"
                      value={analytics.replied}
                      sub={`${analytics.reply_rate}%`}
                      color="#9b59b6"
                    />
                    <AnalyticsBadge
                      label="Bounced"
                      value={analytics.bounced}
                      sub={`${analytics.bounce_rate}%`}
                      color={analytics.bounced > 0 ? '#e07070' : undefined}
                    />
                                ...
                                <>
                                  <span
                                    style={{
                                      fontFamily: 'var(--font-mono)',
                                      fontSize: 10,
                                      color: step.open_rate > 0 ? '#4a7c59' : 'var(--text-muted)',
                                    }}
                                  >
                                    {step.open_rate}% open
                                  </span>
                                  <span
                                    style={{
                                      fontFamily: 'var(--font-mono)',
                                      fontSize: 10,
                                      color: step.click_rate > 0 ? '#0082F3' : 'var(--text-muted)',
                                    }}
                                  >
                              ...
                              {[
                                ...
                                return (
                                  <div
                                    ...
                                    style={{
                                      padding: '8px 14px',
                                      borderRight: v === 'A' ? '1px dashed var(--border)' : 'none',
                                    }}
                                  >
                                    <div
                                      style={{
                                    ...
                                    <div style={{ display: 'flex', gap: 12 }}>
                                      <span
                                        style={{
                                          fontFamily: 'var(--font-mono)',
                                          fontSize: 10,
                                          color: vd.open_rate > 0 ? '#4a7c59' : 'var(--text-muted)',
                                        }}
                                      >
                                        {vd.open_rate || 0}% open
                                      </span>
                                      <span
                                        style={{
                                          ...
                                          fontSize: 10,
                                          color:
                                            vd.click_rate > 0 ? '#0082F3' : 'var(--text-muted)',
                                        }}
                                      >
                                        {vd.click_rate || 0}% click
                                      </span>
                                    </div>
                                  </div>
                                )
              ...
              {tab === 'enrollments' &&
                (enrollments.length === 0 ? (
                  ...
                  >
                    No leads enrolled yet. Enroll from the Leads page.
                  </p>
                ) : (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                    {enrollments.map((enr) => {
                      ...
                      const nextRun = enr.next_run_at
                        ? new Date(enr.next_run_at).toLocaleDateString('en-GB', {
                            day: 'numeric',
                            month: 'short',
                          }) +
                          ' ' +
                          new Date(enr.next_run_at).toLocaleTimeString('en-GB', {
                            hour: '2-digit',
                            minute: '2-digit',
                          })
                        : '—'
                        ...
                        >
                          <div
                            style={{
                              ...
                              height: 8,
                              borderRadius: '50%',
                              background: STATUS_DOT[enr.status] || '#888',
                              flexShrink: 0,
                            }}
                          />
                          <div style={{ flex: 1, minWidth: 0 }}>
                            ...
                            >
                              ...
                              >
                                <div
                                  style={{
                                    height: '100%',
                                    width: `${progress}%`,
                                    background: STATUS_DOT[enr.status] || '#4a7c59',
                                    borderRadius: 2,
                                  }}
                                />
                              </div>
                              ...
                              <span
                                style={{
                                  ...
                                  fontSize: 10,
                                  fontWeight: 600,
                                  color: STATUS_DOT[enr.status] || 'var(--text-muted)',
                                }}
                              >
                                {STATUS_LABEL[enr.status] || enr.status?.toUpperCase()}
                              </span>
                              {enr.reply_sentiment &&
                                enr.status === 'replied' &&
                                (() => {
                                  const SM = {
                                    interested: ['★ INTERESTED', '#4a7c59', 'rgba(74,124,89,0.12)'],
                                    not_interested: [
                                      '✗ NOT INTERESTED',
                                      '#e07070',
                                      'rgba(239,68,68,0.1)',
                                    ],
                                    ooo: ['✈ OOO', '#ca8a04', 'rgba(234,179,8,0.1)'],
                                    wrong_person: [
                                      '⟳ WRONG PERSON',
                                      'var(--text-muted)',
                                      'var(--surface)',
                              ...
                              {enr.ab_variant && (
                                <span
                                  style={{
                                    ...
                                    padding: '1px 6px',
                                    borderRadius: 3,
                                    background: enr.ab_variant === 'A' ? '#4a7c5918' : '#b07d2e18',
                                    border: `1px solid ${enr.ab_variant === 'A' ? '#4a7c5940' : '#b07d2e40'}`,
                                    color: enr.ab_variant === 'A' ? '#4a7c59' : '#b07d2e',
                                  }}
                                >
                                  V{enr.ab_variant}
                                </span>
                              ...
                              {enr.status === 'paused' && enr.ooo_resume_at && (
                                <span
                                  style={{
                                    fontFamily: 'var(--font-mono)',
                                    fontSize: 10,
                                ...
                                >
                                  OOO — resumes{' '}
                                  {new Date(enr.ooo_resume_at).toLocaleDateString('en-GB', {
                                    day: 'numeric',
                                    month: 'short',
                                  })}
                                </span>
                              )}
                              {enr.status === 'replied' && enr.replied_at && (
                                <span
                                  style={{
                                    fontFamily: 'var(--font-mono)',
                                    fontSize: 10,
                                ...
                                >
                                  Replied{' '}
                                  {new Date(enr.replied_at).toLocaleDateString('en-GB', {
                                    day: 'numeric',
                                    month: 'short',
                                  })}
                                </span>
    ...
    >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 4 }}>
            ...
            <span
              style={{
                padding: '2px 8px',
                borderRadius: 20,
                background: STATUS_BG[seq.status],
                color: STATUS_COLOR[seq.status],
                fontFamily: 'var(--font-mono)',
                fontSize: 10,
                fontWeight: 600,
                textTransform: 'uppercase',
      ...
      <div style={{ display: 'flex', gap: 20, flexWrap: 'wrap' }}>
        {[
          ...
          {
            label: 'Replied',
            value: seq.replied_count || 0,
            color: seq.replied_count > 0 ? '#9b59b6' : 'var(--text-muted)',
          },
          {
            label: 'Bounced',
            value: seq.bounced_count || 0,
            color: seq.bounced_count > 0 ? '#e07070' : 'var(--text-muted)',
          },
          {
            label: 'Completed',
            value: seq.completed_count || 0,
            color: seq.completed_count > 0 ? '#0082F3' : 'var(--text-muted)',
          },
        ].map((m) => (
          <div key={m.label}>
            <div
    ...
    steps: [
      {
        type: 'email',
        delay_days: 0,
        subject: 'How {{company}} can [outcome]',
      ...
      },
      {
        type: 'email',
        delay_days: 2,
        subject: 'Case study: [Company] achieved [result]',
      ...
      },
      {
        ...
        delay_days: 4,
        subject: '',
        body: 'Hi {{first_name}}, sent you an email about [topic]. Would love to connect here too.',
      },
      {
        type: 'email',
        delay_days: 7,
...
export default function Sequences() {
  ...
  function openEdit(seq) {
    ...
    setForm({
      ...
      steps: seq.steps?.length ? seq.steps : [{ ...BLANK_STEP }],
    })
    setShowBuilder(true)
  }
  ...
  async function handleToggle(seq) {
    ...
    if (next === 'active') {
      ...
      if (sendStats && sendStats.remaining === 0) {
        warnings.push(
          `Daily send limit reached (${sendStats.daily_limit}/day). Emails will send tomorrow.`
        )
      }
      if (
        warnings.length > 0 &&
                ...
                <button
                  ...
                  onClick={async () => {
                    ...
                    if (serverTemplates.length === 0) {
                      setTplLoading(true)
                      try {
                        const r = await listSequenceTemplates()
                        setServerTemplates(r.data.templates || [])
                      } catch {}
                      setTplLoading(false)
                    }
                  }}
              ...
              >
                ...
                >
                  <div>
                    ...
                    >
                      One click to create — all steps pre-written, ready to customize.
                    </div>
                  </div>
                  <button
                          ...
                          <button
                            onClick={async () => {
                              ...
                              try {
                                ...
                                alert('Failed to create sequence from template')
                              }
                              setTplCreating('')
                            }}
                            ...
                            style={{
                              ...
                              fontWeight: 600,
                              padding: '8px 14px',
                              background: tplCreating === tpl.id ? '#4a7c59' : 'var(--accent)',
                              color: '#fff',
                              border: 'none',
                              borderRadius: 6,
                              cursor: tplCreating ? 'default' : 'pointer',
                              whiteSpace: 'nowrap',
                            }}
                          >
              ...
              >
                ...
                >
                  <div>
                    ...
                    >
                      Generate a complete sequence with AI
                    </div>
                  </div>
                  <button
                ...
                >
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => setAiForm((f) => ({ ...f, product: e.target.value }))}
                  ...
                  <div style={{ display: 'flex', gap: 12 }}>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <select
                        value={aiForm.num_steps}
                        onChange={(e) =>
                          setAiForm((f) => ({ ...f, num_steps: parseInt(e.target.value) }))
                        }
                        style={{ ...s.input, width: '100%', boxSizing: 'border-box' }}
                      >
                  ...
                  {aiError && (
                    <div style={{ fontFamily: 'var(--font-mono)', fontSize: 11, color: '#e07070' }}>
                      {aiError}
                    </div>
                  )}
                  <button
            ...
            <div style={{ display: 'flex', gap: 16 }}>
              <div style={{ flex: 2 }}>
                ...
                <input
                  ...
                  placeholder="e.g. Cold Outreach — Series B SaaS"
                  required
                />
              </div>
              <div style={{ flex: 1 }}>
                ...
                <input
                  ...
                  placeholder="Target audience, goal…"
                />
              </div>
            </div>
      ...
      <div style={s.inner}>
            ...
            {sendStats && (
              <div
                style={{
                  ...
                  padding: '7px 14px',
                  background: 'var(--surface)',
                  border: `1px solid ${sendStats.remaining === 0 ? '#e07070' : sendStats.remaining < 10 ? '#b07d2e40' : 'var(--border)'}`,
                  borderRadius: 8,
                }}
              >
                <div
                  style={{
                    ...
                    borderRadius: '50%',
                    background:
                      sendStats.remaining === 0
                        ? '#e07070'
                        : sendStats.remaining < 10
                          ? '#b07d2e'
                          : '#4a7c59',
                    flexShrink: 0,
                  }}
                ...
                >
                  <span
                    style={{
                      color: sendStats.remaining === 0 ? '#e07070' : 'var(--text)',
                      fontWeight: 600,
                    }}
                  >
                    {sendStats.sent_today}
                  </span>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: '80px 0' }}>
            ...
            >
              No sequences yet. Create your first outreach campaign.
            </p>
            <button style={s.btn} onClick={openNew}>
              Create sequence
            </button>
