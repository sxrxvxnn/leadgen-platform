      ...
      <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: 0 }}>
        ...
        <div style={{ padding: '48px 56px', display: 'flex', flexDirection: 'column', justifyContent: 'center', overflowY: 'auto', background: SURF }}>
          ...
          >
            ...
            <p style={{ fontFamily: SANS, fontSize: 13, color: STEEL, marginBottom: 22 }}>Start for free — no credit card required.</p>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
              ...
              <span style={{ fontFamily: SANS, fontSize: 10, color: STEEL, letterSpacing: '0.06em', textTransform: 'uppercase', flexShrink: 0 }}>or continue with email</span>
              <div style={{ flex: 1, height: 1, background: BORDER }} />
            </div>
