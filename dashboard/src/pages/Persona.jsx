...
const s = {
  ...
  heroTitle: { fontFamily: "var(--font-display)", fontSize: 'clamp(40px, 5vw, 64px)', fontWeight: '400', letterSpacing: '-1.5px', color: 'var(--text)', lineHeight: 1 },
  heroUnit: { fontFamily: "var(--font-display)", fontSize: 'clamp(20px, 2.5vw, 32px)', fontWeight: '400', color: 'var(--text-muted)', letterSpacing: '-0.5px' },
