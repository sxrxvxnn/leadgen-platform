  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: 6, display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>
        {note && (
          <span style={{ fontFamily: MONO, fontSize: 9, color: 'var(--text-muted)' }}>{note}</span>
        )}
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <p style={{ fontFamily: MONO, fontSize: 9, color: 'var(--text-muted)', margin: '2px 0 0' }}>
          {time}
        </p>
      </div>
    </div>
    ...
    >
      <div
        style={{
          ...
          height: 6,
          borderRadius: '50%',
          background: task.priority === 'high' ? 'var(--accent)' : 'var(--border-strong)',
          flexShrink: 0,
        }}
      />
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        {lead.name && (
          <p
            style={{ fontFamily: MONO, fontSize: 9, color: 'var(--text-muted)', margin: '2px 0 0' }}
          >
            {lead.name}
      ...
      <span
        style={{
          ...
          fontSize: 9,
          fontWeight: 600,
          color: isPast ? '#e07070' : 'var(--text-muted)',
          flexShrink: 0,
        }}
      >
        {dueStr}
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
                  ...
                  {changelog.slice(0, 5).map((entry, i) => (
                    <div
                      ...
                      style={{
                        padding: '12px 16px',
                        borderBottom:
                          i < Math.min(changelog.length, 5) - 1
      ...
      >
        <StatCard
          ...
          color="var(--text)"
          note="in pipeline"
          trend={{ thisWeek: L.this_week || 0, lastWeek: L.last_week || 0 }}
          loading={loading}
        ...
        <StatCard
          label="Emails Sent"
          value={S.emails_sent || 0}
          color="#a86448"
          note={`${S.avg_open_rate || 0}% open rate`}
          loading={loading}
            ...
            return (
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 5 }}>
                  ...
                  <span style={{ fontFamily: MONO, fontSize: 9, color, fontWeight: 700 }}>
                    {pct}% · {value}
                  </span>
                </div>
                <div
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 10 }}>
                {[
                  { label: 'Sent', value: S.emails_sent || 0, color: 'var(--text)' },
                  {
                    ...
                    color: (S.avg_open_rate || 0) > 20 ? '#4a7c59' : 'var(--text)',
                  },
                  {
                    label: 'Click Rate',
                    value: `${S.avg_click_rate || 0}%`,
                    color: (S.avg_click_rate || 0) > 5 ? '#0082F3' : 'var(--text)',
                  },
            ...
            {loading ? (
              ...
              <>
                <div
                  style={{
                    display: 'grid',
                    gridTemplateColumns: '2fr 1fr 1fr 90px 60px',
                    padding: '8px 0',
                    borderBottom: '1px solid var(--border)',
                  }}
                >
                ...
                <div style={{ padding: '32px 0', textAlign: 'center' }}>
                  ...
                  >
                    {L.total} leads in pipeline — {L.new} new, {L.contacted} contacted,{' '}
        ...
        <div style={{ padding: '24px 24px 48px' }}>
                ...
                {jobAlerts.slice(0, 5).map((alert) => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        padding: '10px 12px',
                        background: alert.seen ? 'var(--bg)' : 'rgba(176,125,46,0.06)',
                        border: `1px solid ${alert.seen ? 'var(--border)' : 'rgba(176,125,46,0.25)'}`,
                        borderRadius: 7,
                        position: 'relative',
                      }}
                    >
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          {isBounce ? (
                            ...
                            >
                              {alert.old_company &&
                              alert.new_company &&
                              alert.old_company !== alert.new_company ? (
                                <>
                                  {alert.old_company} <span style={{ color: '#b07d2e' }}>→</span>{' '}
                                  {alert.new_company}
                                </>
                              ) : (
                      ...
                      >
                        {isBounce ? 'Email bounce' : 'Detected via extension'} ·{' '}
          ...
          <div>
            ...
            {loading ? (
              ...
              >
                No activity yet. Send an email or enrich a lead to get started.
              </p>
            ) : (
