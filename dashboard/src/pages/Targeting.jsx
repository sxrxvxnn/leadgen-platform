      ...
      <div style={{ position: 'relative' }}>
        <input
          ...
          style={{
            ...
            background: 'var(--bg)',
            border: `1px solid ${open ? 'rgba(29,27,27,0.28)' : 'var(--border)'}`,
            borderRadius: open && filtered.length > 0 ? '7px 7px 0 0' : '7px',
      ...
      {open && filtered.length > 0 && (
        <div
          style={{
            ...
            zIndex: 300,
            background: 'var(--bg)',
            border: '1px solid rgba(29,27,27,0.18)',
            borderTop: 'none',
            borderRadius: '0 0 7px 7px',
            boxShadow: '0 10px 30px rgba(29,27,27,0.10)',
            maxHeight: '240px',
            overflowY: 'auto',
          }}
        >
          {filtered.map((c) => (
            <button
              ...
              style={{
                ...
                gap: '10px',
                padding: '9px 12px',
                background: selected?.id === c.id ? 'rgba(168,100,72,0.06)' : 'transparent',
                border: 'none',
                cursor: 'pointer',
                textAlign: 'left',
              }}
...
function PersonCard({ person, addState, onAdd, existingLead }) {
  ...
  return (
    <div
      style={{
        background: 'var(--bg)',
        border: `1px solid ${isAdded ? 'rgba(74,124,89,0.3)' : 'var(--border)'}`,
        borderRadius: '9px',
        padding: '14px 16px',
        display: 'flex',
        ...
        {isAdded ? (
          ...
          <button
            ...
            style={{
              marginLeft: 'auto',
              padding: '5px 12px',
              background: isAdding ? 'var(--surface)' : 'var(--text)',
              color: isAdding ? 'var(--text-muted)' : '#FFFFFF',
              border: 'none',
              borderRadius: '5px',
              fontFamily: 'var(--font-mono)',
              fontSize: '10px',
...
export default function Targeting() {
  ...
  const companyLeads = useMemo(() => {
    ...
    return existingLeads.filter(
      (l) => (l.company || '').toLowerCase() === (selectedCompany.name || '').toLowerCase()
    )
  ...
  function isAlreadyLead(person) {
    ...
    const n = `${person.first_name || ''} ${person.last_name || ''} ${person.company || ''}`
      .trim()
      .toLowerCase()
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      >
        <div style={{ position: 'relative' }}>
          ...
          >
            Pick a company from your workspace, filter by role, then find and add decision makers
            directly to your leads list.
          </p>
        </div>
      </motion.div>

      <motion.div
        style={{ display: 'flex', minHeight: 'calc(100vh - 208px)' }}
      ...
      >
        ...
        >
          ...
          <div>
            <p style={stepLbl}>
              <span style={stepNum}>1</span>Select Company
            </p>
          ...
          <div>
            <p style={stepLbl}>
              <span style={stepNum}>2</span>Filter by Role
            </p>
            <p
              style={{
                fontFamily: 'var(--font-mono)',
            ...
            >
              Leave blank to find all members
            </p>
          ...
          <div>
            <p style={stepLbl}>
              <span style={stepNum}>3</span>Find Contacts
            </p>
            <div style={{ marginTop: '10px' }}>
              <button
                ...
                style={{
                  width: '100%',
                  padding: '10px 16px',
                  background: selectedCompany ? 'var(--text)' : 'var(--surface)',
                  color: selectedCompany ? '#FFFFFF' : 'var(--text-muted)',
                  border: 'none',
                  borderRadius: '7px',
                  fontFamily: 'var(--font-mono)',
                  fontSize: '11px',
            ...
            <div>
              ...
              {searchResults === null && !searching ? (
                ...
                <div style={{ padding: '48px 0', textAlign: 'center' }}>
                  ...
                  >
                    Searching Hunter + LinkedIn for people at {selectedCompany.name}…
                  </p>
                </div>
                ...
                >
                  ...
                  >
                    Try removing role filters or searching by a different company name.
                  </p>
                </div>
              ) : (
                <div>
