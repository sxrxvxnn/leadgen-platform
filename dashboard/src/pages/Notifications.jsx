    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        >
          ...
          <span
            style={{ fontFamily: MONO, fontSize: 10, color: 'var(--text-muted)', flexShrink: 0 }}
          >
...
export default function Notifications() {
  ...
  const filtered = notifications.filter((n) => {
    ...
    if (filter === 'Company Alerts')
      return ['funding', 'hiring', 'compliance', 'news', 'growth', 'company_alert'].includes(n.type)
    return true
  })
        ...
        {loading ? (
          <div style={{ padding: 40, textAlign: 'center' }}>
            {[...Array(4)].map((_, i) => (
              ...
              >
                <div
                  style={{ width: 36, height: 36, borderRadius: 8, background: 'var(--surface)' }}
                />
                <div style={{ flex: 1 }}>
                  <div
                    style={{
